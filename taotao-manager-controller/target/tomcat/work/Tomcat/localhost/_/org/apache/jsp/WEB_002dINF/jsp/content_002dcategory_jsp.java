 ...
 * Generated at: 2017-06-11 05:38:56 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tonContextMenu: function(e,node){//右键点击，弹出菜单\r\n");
      out.write("            e.preventDefault();//阻止冒泡事件，阻止浏览器本身的右键菜单\r\n");
      ...
      out.write("            });\r\n");
      out.write("        },\r\n");
      out.write("        onAfterEdit : function(node){//编辑结束\r\n");
      out.write("        \tvar _tree = $(this);\r\n");
      out.write("        \tif(node.id == 0){\r\n");
      out.write("        \t\t// 新增节点，保存到数据库\r\n");
      ...
      out.write("\t\ttree.tree(\"select\",_node.target).tree('beginEdit',_node.target);//beginEdit 是进入编辑状态\r\n");
